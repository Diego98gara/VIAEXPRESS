...
public class CambioEstadoServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        PujaDao pujadao = new PujaDao();

        int idenvio = Integer.parseInt(request.getParameter("idEnvio"));
        int idpuja = Integer.parseInt(request.getParameter("idPuja")); 
        String json = new Gson().toJson(pujadao.setPujaSeleccionada(idenvio, idpuja));
