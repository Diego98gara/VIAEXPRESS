...
import co.edu.sena.ViaExpress.persistencia.dao.VehiculoDao;
...
public class NuevoVehiculoServlet extends HttpServlet {
    ...
    String vistaTrasportista = "Vistas/VistaTransportista.jsp";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String action = request.getParameter("RegistrarVehiculo");
        String Placa = request.getParameter("Placa");
        int tipoVehiculo = Integer.parseInt(request.getParameter("TipoVehiculo"));
        String Modelo = request.getParameter("Modelo");
        if (action.equalsIgnoreCase("RegistarVehicula")) {
         vehiculodao.getcrearvehivulo(Placa, tipoVehiculo, Modelo,idusuario);
         acceso = vistaTrasportista;
        }
